...
CREATE TABLE posts (
    ...
    updated_at timestamp without time zone,
    user_id integer,
    post_image_file_name character varying,
    post_image_content_type character varying,
...
--
-- Name: post_body; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX post_body ON posts USING gin (to_tsvector('english'::regconfig, body));


--
-- Name: post_title; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX post_title ON posts USING gin (to_tsvector('english'::regconfig, (title)::text));
...
INSERT INTO schema_migrations (version) VALUES ('20150206052633');

INSERT INTO schema_migrations (version) VALUES ('20150216191030');

INSERT INTO schema_migrations (version) VALUES ('20150217191847');

INSERT INTO schema_migrations (version) VALUES ('20150220190945');

INSERT INTO schema_migrations (version) VALUES ('20150223193226');

INSERT INTO schema_migrations (version) VALUES ('20150223194228');

INSERT INTO schema_migrations (version) VALUES ('20150223194658');

INSERT INTO schema_migrations (version) VALUES ('20150223230313');

INSERT INTO schema_migrations (version) VALUES ('20150224172555');

INSERT INTO schema_migrations (version) VALUES ('20150302105953');

INSERT INTO schema_migrations (version) VALUES ('20150302164050');
